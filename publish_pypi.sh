...
#
# Usage:
#   ./publish_pypi.sh                 # auto bump patch, build, upload to PyPI
#   ./publish_pypi.sh --version 1.0.2  # set an exact version
#   ./publish_pypi.sh --dry-run        # bump/build/check, but do not upload
#   ./publish_pypi.sh --testpypi       # upload to TestPyPI
#
# Token options:
